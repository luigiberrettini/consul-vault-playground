...
function startTemplateRenderer()
{
    ...
    docker run --link $containerName:consul -d -v $templateFolder:/work consultmpl8 consul-template -consul consul:8500 -template "/work/$templateName:/work/$outputName"
